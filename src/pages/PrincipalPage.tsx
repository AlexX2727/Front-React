...
import ProfileComponent from "../components/ProfileComponent"; // Importa el componente de perfil

function PrincipalPage() {
  const navigate = useNavigate();
  const [currentTime, setCurrentTime] = useState(new Date());
  const [greeting, setGreeting] = useState("");
  const [activeSection, setActiveSection] = useState("inicio"); // Para controlar qué sección se muestra
      ...
      <div style={styles.sidebar}>
        ...
        <nav style={styles.nav}>
          ...
          <button 
            style={{
              ...styles.navButton, 
              ...(activeSection === "proyectos" ? styles.activeNavButton : {})
            }} 
